...
DisplayView.prototype.render = function(){
 ...
 for (let book of this.books) {
    ...
    var markerJura = L.marker([56.068, -5.77]);
    var markerHampStead = L.marker([51.558, -0.173])
    var markerParis = L.marker([48.804, 2.29]);
    var markerWallington = L.marker([51.357, - 0.149]);
    ...
    const orwellLocations = [markerJura, markerHampStead, markerParis, markerWallington];
    const package = [orwellLocations, view]
